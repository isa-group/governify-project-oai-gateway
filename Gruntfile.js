...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        //JSLINT 
        jshint: {
            all: ['Gruntfile.js', 'src/**/*.js', '!**/tests/**', '!**/frontend/**', '!**/frontend/report/**', '!**/frontend/coverage/**', '!**/backend/node_modules/**', 'tests/**/*.js', 'index.js'], //If you want to inspect more file, you change this.
            options: {
                jshintrc: '.jshintrc'
            }
        },
